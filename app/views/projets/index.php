  ...
  <?php foreach($data['projets'] as $projet) : ?>
    <div class="card card-body mb-3">
      ...
      <div class="bg-light p-2 mb-3">
        Written by <?php echo $projet->name; ?> on <?php echo $projet->projetCreated; ?>
      </div>
      <!-- <p class="card-text"><?php echo $projet->body; ?></p> -->
      <a href="<?php echo URLROOT; ?>/projets/show/<?php echo $projet->projetId; ?>" class="btn btn-dark">Tasks</a>
    </div>
  <?php endforeach; ?>
